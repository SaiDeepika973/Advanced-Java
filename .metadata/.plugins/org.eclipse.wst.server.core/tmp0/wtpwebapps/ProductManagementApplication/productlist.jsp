...
<tbody>
	<c:forEach var="product" items="<%=new ProductDao().findAll()%>">
		...
		<tr>
			...
			<td><img src="data:image/jpeg;base64,${Base64.getEncoder().encodeToString(product.getProImage())}" alt="ProductImage" style="max-width: 100px; max-height:100px;"></td>
			<td><audio controls><source src="data:audio/jpeg;base64,${Base64.getEncoder().encodeToString(product.getProAudio())}" type="audio/mpeg"></audio></td>
			<td><video controls width="320" height="240"><source src="data:video/jpeg;base64,${Base64.getEncoder().encodeToString(product.getProVideo())}" type="video/mp4"></video></td>
			<td>
